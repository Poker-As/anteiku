 ...
 * @author richa
 */
public class Regsitro_Empleado extends javax.swing.JFrame {

    /**
     * Creates new form Regsitro_Empleado
     */
    public Regsitro_Empleado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Regsitro_Empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Regsitro_Empleado().setVisible(true);
            }
        });
    }
